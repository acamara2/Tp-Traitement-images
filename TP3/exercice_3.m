...
Vomax=(V_oeillets>=V_chrysanthemes) & (V_oeillets >=V_pensees);
Vcmax=(V_chrysanthemes>V_oeillets) & (V_chrysanthemes >V_pensees);
Vpmax=(V_pensees>V_oeillets) & (V_pensees >=V_chrysanthemes);
code_classe=1*Vomax+2*Vcmax+3*Vpmax;
